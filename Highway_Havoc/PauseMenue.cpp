...
void PauseMenue::aktualisieren()
{
	...
	if (this->eingabeverwaltung->getTastenStatusGeandertIndex(0) && this->auswahl > 0) 	//	Die Eingabe überprüfen und die Auswahl anpassen
	{
		this->auswahl -= 1;

	}
	if (this->eingabeverwaltung->getTastenStatusGeandertIndex(1) && this->auswahl < 2) 	//	Die Eingabe überprüfen und die Auswahl anpassen
	{
		this->auswahl += 1;
